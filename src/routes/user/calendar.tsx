...
import {
	Container,
	Section,
} from "#/templates/modern/components/layout/PageShell";
import { Segmented } from "#/templates/modern/components/Segmented";
import {
	Eyebrow,
	Statement,
	WidgetCaption,
} from "#/templates/modern/components/Text";
			...
			<Section testId="calendar-intro">
				<Container>
					...
					<div className="grid items-end gap-8 lg:grid-cols-12">
						...
						<p className="max-w-measure text-body-l text-n-600 lg:col-span-4">
							{calendarIntro.support}
						</p>
					</div>
				...
				<Container>
					<div className="flex flex-col gap-6">
								...
								return (
									<button
										...
										className={cn(
											...
											on
												? "border-ink text-ink"
												: "border-n-300 text-n-500 line-through",
										)}
									>
						...
						<div className="mt-6 flex flex-wrap items-center gap-3">
							<span className="u-label mr-2 text-n-600">
								Export a whole term
							</span>
							{terms.map((t) => (
								<Button

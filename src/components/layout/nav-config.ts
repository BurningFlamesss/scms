...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: "Scholarships", to: "/admin/scholarships", icon: GraduationCap, permission: "admissions.view" },
    ],
  },
  {
    label: "People",
    ...
    items: [
      {
        ...
        children: [
          { label: "Home", to: "/admin/website?page=home" },
          { label: "About", to: "/admin/website?page=about" },
          { label: "Courses", to: "/admin/website?page=courses" },
          { label: "Facilities", to: "/admin/website?page=facilities" },
          { label: "Gallery", to: "/admin/website?page=gallery" },
          { label: "Calendar", to: "/admin/website?page=calendar" },
          { label: "Contact", to: "/admin/website?page=contact" },
          { label: "Resources", to: "/admin/website?page=resources" },
          { label: "Results", to: "/admin/website?page=result" },
        ],
      },
    ],
  },

...
const secondaryBtn =
	"inline-flex items-center justify-center gap-2 rounded-full border border-neutral-300 bg-white px-7 py-3.5 text-sm font-medium text-neutral-900 no-underline transition-colors hover:border-neutral-400";
					...
					<div className="flex flex-wrap gap-2.5">
						{links.map((link) => (
							<a
								...
								target="_blank"
								rel="noreferrer"
								className="rounded-full border border-neutral-300 bg-white px-4 py-1.5 text-sm text-neutral-700 no-underline transition-colors hover:border-neutral-400"
							>
								{link.label}
							</a>
						))}

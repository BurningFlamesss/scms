...
export function SheetRise({
  ...
  if (reduced) {
    return (
      <div>
        ...
        <div className='relative z-sheet -mt-8 rounded-t-lip bg-paper shadow-high' data-testid='white-sheet'>
          {children}
        </div>
      </div>
    );
  ...
  return (
    <div ref={ref} className='relative'>
      ...
      <div className='relative z-sheet rounded-t-lip bg-paper shadow-high' data-testid='white-sheet'>
        {children}
      </div>
    </div>
  );

    ...
    return (
      <div className='flex flex-col gap-3 border-t-hair border-paper/20 pt-6' data-testid='memory-hidden'>
        ...
        <button
          ...
          className='u-label inline-flex w-fit min-h-tap items-center gap-2 rounded-ui border-hair border-paper/40 px-3 text-paper transition-colors duration-micro ease-state hover:bg-paper/10 hover:border-paper'
        >
    ...
    >
          ...
          return (
            <li key={tile.key}>
              ...
              >
                ...
                >
                  <span
                    className='absolute inset-0 flex items-center justify-center rounded-ui border-hair border-paper/50 bg-paper/[0.14]'
                  ...
                  <span
                    className={cn(
                      ...
                      isMatched ? 'border-paper/40 bg-paper/70' : 'border-paper bg-paper',
                    )}
      ...
      <div className='flex flex-wrap gap-2'>
        <button
          ...
          className='u-label inline-flex min-h-tap items-center gap-2 rounded-ui border-hair border-paper/40 px-3 text-paper transition-colors duration-micro ease-state hover:border-paper hover:bg-paper/10'
        >

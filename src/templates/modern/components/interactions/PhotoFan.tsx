      ...
      <span className='relative block aspect-[4/3] w-full'>
        {reduced ? (
          ...
          top.map((p, i) => (
            <motion.span
              key={p.src + i}
              className='absolute inset-0 block overflow-hidden rounded-card border-hair border-n-200 bg-paper shadow-low'
        ...
        <span className='u-label absolute bottom-3 right-3 z-10 rounded-pill bg-paper px-3 py-1 tnum text-ink'>
